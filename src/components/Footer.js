...
export default function Footer() {
  return (
    <footer className="bg-gray-100 py-8 px-4 md:py-10 md:px-6 lg:px-8">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          {/* Link Columns */}
          <div>
            <h3 className="text-black font-bold mb-4 text-sm md:text-base">
              COMPANY
            </h3>
        ...
        <div className="mt-8 pt-6 border-t border-gray-300">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-xs md:text-sm text-center md:text-left">
              Wearwise © 2022-2025, Nghia, My, Hung, Huyen
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <svg
                ...
                className="w-12 h-8"
              >
                <g filter="url(#filter0_dd_1248_6222)">
                  <rect
                    x="10"
                    y="5"
                    width="46.6143"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      ...
                      result="effect1_dropShadow_1248_6222"
                    />
                    <feColorMatrix
                      in="SourceAlpha"
                      type="matrix"
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_dropShadow_1248_6222"
                      result="effect2_dropShadow_1248_6222"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect2_dropShadow_1248_6222"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <svg
                ...
                className="w-12 h-8"
              >
                <g filter="url(#filter0_dd_1248_6224)">
                  <rect
                    x="9.61426"
                    y="5"
                    width="46.6143"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_1248_6224"
                    />
                    <feColorMatrix
                      in="SourceAlpha"
                      type="matrix"
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_dropShadow_1248_6224"
                      result="effect2_dropShadow_1248_6224"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect2_dropShadow_1248_6224"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <svg
                ...
                className="w-12 h-8"
              >
                <g filter="url(#filter0_dd_1248_6226)">
                  <rect
                    x="9.22852"
                    y="5"
                    width="46.6143"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_1248_6226"
                    />
                    <feColorMatrix
                      in="SourceAlpha"
                      type="matrix"
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_dropShadow_1248_6226"
                      result="effect2_dropShadow_1248_6226"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect2_dropShadow_1248_6226"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <svg
                ...
                className="w-12 h-8"
              >
                <g filter="url(#filter0_dd_1248_6228)">
                  <rect
                    x="9.8429"
                    y="5"
                    width="46.6143"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_1248_6228"
                    />
                    <feColorMatrix
                      in="SourceAlpha"
                      type="matrix"
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_dropShadow_1248_6228"
                      result="effect2_dropShadow_1248_6228"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect2_dropShadow_1248_6228"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <svg
                ...
                className="w-12 h-8"
              >
                <g filter="url(#filter0_dd_1248_6230)">
                  <rect
                    x="9.45715"
                    y="5"
                    width="46.6143"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_1248_6230"
                    />
                    <feColorMatrix
                      in="SourceAlpha"
                      type="matrix"
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_dropShadow_1248_6230"
                      result="effect2_dropShadow_1248_6230"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect2_dropShadow_1248_6230"
                      result="shape"
                    />
                  </filter>
                </defs>
